...
pub const AUTO_GENERATE_GAMES_NUMBER: usize = 12;
...
pub const SATISFACTION_DECREASE_PER_LONG_TICK: f32 = -0.175;
...
pub const SATISFACTION_MALUS_UNPAID_SALARIES: Skill = -1.75;
