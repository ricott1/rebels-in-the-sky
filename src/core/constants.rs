...
pub const MORALE_INCREASE_AFTER_TOURNAMENT_GAME: f32 = MoraleModifier::SEVERE_BONUS;
pub const MORALE_RELEASE_MALUS: f32 = MoraleModifier::SEVERE_MALUS;
pub const SATISFACTION_THRESHOLD_FOR_LEAVING: f32 = 4.0;
pub const SATISFACTION_MALUS_FOR_MORALE_DROP: f32 = 1.0;
pub const SATISFACTION_MALUS_FOR_SITTING_OUT: f32 = 0.1;
pub const SATISFACTION_PER_OPINION_EVENT: f32 = 0.25;
pub const SATISFACTION_OPINION_RECOVERY_TIME: Tick = DAYS;
pub const SATISFACTION_OPINION_MODIFIER_WEIGHT: f32 = 2.2;
...
pub const PLAYER_SCOUTING_PER_GAME: Skill = 0.75;
